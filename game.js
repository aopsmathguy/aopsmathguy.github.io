...
var renderClouds = function(pltfrms){
    for (var i = 0; i < pltfrms.length; i++)
    {
        ...
        var render = new component(pltfrm.x+pltfrm.offset,pltfrm.y+pltfrm.height/2+scrollHeight/2,0,pltfrm.width,pltfrm.height, pltfrm.color, pltfrm.type);
        render.display();
    }
}
...
var renderPlatforms = function(pltfrms){
    ...
    {
        var pltfrm = pltfrms[i];
        var render = new component(pltfrm.x+pltfrm.offset,pltfrm.y+pltfrm.height/2+scrollHeight,0,pltfrm.width,pltfrm.height, pltfrm.color, pltfrm.type);
        render.display();
    }
}
...
function component(x, y, dir, width, height, color, type) {
    this.type = type;
    if (type == "image") {
